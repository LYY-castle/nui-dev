<template>
  <div class="container">
    <el-row class="table-container" v-if="tableShow">
      ...
      <el-row class="margin-bottom-20">
        <el-button type="success" size="small" @click="createWorkFrom()"
          >新建</el-button
        >
        <el-button type="danger" size="small" @click="mutipledelVisible = true"
          >批量删除</el-button
        >
      ...
      <el-row :gutter="20" class="colmn">
        ...
        <el-col :span="3" class="leftside" v-if="show === 1 || show === 2">
          <el-menu class="el-menu-vertical-demo">
            <el-menu-item index="12" style="font-size:18px;font-weight:800"
              >控件列表</el-menu-item
            >
        ...
        <el-col :span="13" style="background-color: #fff;">
          <div class="template">
            ...
            <div class="title" @click="changeTitle" style="text-align:center">
              {{ workFormTable.name }}
            </div>
            <div
              class="selectShow"
          ...
          >
            ...
            <div v-if="item.dataType === 'radio'">
              <div>
                ...
                <div>
                  <div
                    v-for="(item5, index5) in item.dataValues"
                    :key="index5"
                    class="addDemo"
                  >
                    <div>
            ...
            <div v-if="item.dataType === 'checkout'">
              <div>
                <div>
                  <span>选择项</span>
                </div>
                <div>
                  <div
                    v-for="(item6, index6) in item.dataValues"
                    :key="index6"
                    class="addDemo"
                  >
                    <div>
            ...
            <div v-if="item.dataType === 'select'||item.dataType === 'multipleSelect'">
              <div>
                ...
                <div
                  v-for="(item7, index7) in item.dataValues"
                  :key="index7"
                  class="addDemo"
                >
                  <div>
            ...
            <div>
              ...
              <div>
                <div v-if="item.dataType === 'multipleSelect'">
    ...
    >
      ...
      <div slot="footer" class="dialog-footer" style="text-align: right;">
        <el-button
          ...
          >确定</el-button
        >
        <el-button type="primary" plain @click="singledelVisible = false"
          >取消</el-button
        >
      </div>
    </el-dialog>
    ...
    <el-dialog
      width="30%"
      title="操作提示"
      :visible.sync="mutipledelVisible"
      append-to-body
    >
      ...
      <div slot="footer" class="dialog-footer" style="text-align: right;">
        <el-button
          ...
          >确定</el-button
        >
        <el-button type="primary" plain @click="mutipledelVisible = false"
          >取消</el-button
        >
      </div>
    </el-dialog>
